...
export function createKart(kartIndex = 1) {
  ...
  // Debug: red border showing sprite bounds (billboard)
  ...
  border.scale.copy(sprite.scale);
  border.position.copy(sprite.position);
